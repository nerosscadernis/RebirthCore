...
namespace Rebirth.Common.Protocol.Messages
{
    ...
    public class IdentificationMessage : NetworkMessage
    {
        ...
        public IdentificationMessage(bool autoconnect, bool useCertificate, bool useLoginToken, Types.VersionExtended version, string lang, byte[] credentials, short serverId, double sessionOptionalSalt, uint[] failedAttempts)
        {
